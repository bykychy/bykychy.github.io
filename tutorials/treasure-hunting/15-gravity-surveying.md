...
<div class="learning-objectives">
  ...
  <ul>
    <li>Apply Newton's law of gravitation to predict anomalies from buried density contrasts (voids, ore bodies, faults) at scales relevant to Central Asian geology</li>
    <li>Operate relative and absolute gravimeters, design base-station loop surveys, and apply drift and tidal corrections to field readings</li>
    <li>Perform full Bouguer reduction: latitude, free-air, Bouguer slab, and terrain corrections to isolate subsurface density anomalies</li>
    <li>Separate regional from residual gravity anomalies using polynomial fitting and wavelength filtering for target-scale interpretation</li>
    <li>Conduct microgravity surveys for archaeological prospection — detecting tombs, tunnels, and voids in kurgan and Silk Road contexts</li>
  </ul>
</div>
...
<div class="prerequisites">
  ...
  <ul>
    <li>Understanding of Newtonian mechanics: gravitational force, acceleration, and potential energy</li>
    <li>Familiarity with coordinate systems, map projections, and elevation data (GNSS or levelling)</li>
    <li>Basic statistics and curve-fitting skills for data reduction and anomaly separation</li>
    <li>Knowledge of Central Asian geological settings: sedimentary basins, loess cover, and tectonic structures</li>
  </ul>
</div>
...
<div class="concept-diagram">
  <svg viewBox="0 0 620 320" xmlns="http://www.w3.org/2000/svg" style="max-width: 580px;">
    ...
    <text x="310" y="22" text-anchor="middle" font-family="Inter, sans-serif" font-size="13" font-weight="bold" fill="#111">Gravity Survey Concept</text>

    <!-- Gravity anomaly profile (top) -->
    <text x="50" y="42" font-family="Inter, sans-serif" font-size="9" font-weight="bold" fill="#111">Bouguer Anomaly Profile</text>
    <line x1="50" y1="105" x2="580" y2="105" stroke="#68625b" stroke-width="0.5" stroke-dasharray="2,2"/>
    <text x="44" y="108" text-anchor="end" font-family="Inter, sans-serif" font-size="7" fill="#68625b">0</text>

    <!-- Anomaly curve — negative over void, positive over dense body -->
    <path d="M 50,100 Q 100,98 150,95 Q 190,85 210,60 Q 230,50 250,55 Q 270,60 290,85 Q 310,97 350,105 Q 380,108 410,115 Q 440,125 460,130 Q 480,125 500,115 Q 530,108 560,105 L 580,104" fill="none" stroke="#1e4f8a" stroke-width="2"/>
    <!-- Positive anomaly label -->
    <text x="250" y="46" text-anchor="middle" font-family="Inter, sans-serif" font-size="8" fill="#1e4f8a">+ anomaly</text>
    <!-- Negative anomaly label -->
    <text x="460" y="140" text-anchor="middle" font-family="Inter, sans-serif" font-size="8" fill="#1e4f8a">− anomaly</text>
    <!-- Y-axis label -->
    <text x="30" y="80" text-anchor="middle" font-family="Inter, sans-serif" font-size="8" fill="#111" transform="rotate(-90,30,80)">mGal</text>

    <!-- Gravimeter stations -->
    <g fill="#111">
      <rect x="145" y="150" width="8" height="12" rx="2" fill="#1e4f8a"/>
      <line x1="149" y1="162" x2="143" y2="168" stroke="#68625b" stroke-width="1"/>
      <line x1="149" y1="162" x2="155" y2="168" stroke="#68625b" stroke-width="1"/>
      <rect x="245" y="150" width="8" height="12" rx="2" fill="#1e4f8a"/>
      <line x1="249" y1="162" x2="243" y2="168" stroke="#68625b" stroke-width="1"/>
      <line x1="249" y1="162" x2="255" y2="168" stroke="#68625b" stroke-width="1"/>
      <rect x="345" y="150" width="8" height="12" rx="2" fill="#1e4f8a"/>
      <line x1="349" y1="162" x2="343" y2="168" stroke="#68625b" stroke-width="1"/>
      <line x1="349" y1="162" x2="355" y2="168" stroke="#68625b" stroke-width="1"/>
      <rect x="455" y="150" width="8" height="12" rx="2" fill="#1e4f8a"/>
      <line x1="459" y1="162" x2="453" y2="168" stroke="#68625b" stroke-width="1"/>
      <line x1="459" y1="162" x2="465" y2="168" stroke="#68625b" stroke-width="1"/>
    </g>
    <text x="250" y="148" text-anchor="middle" font-family="Inter, sans-serif" font-size="7" fill="#1e4f8a">gravimeter</text>

    <!-- Ground surface -->
    <rect x="50" y="170" width="530" height="3" fill="#8b5e00"/>
    <text x="590" y="175" text-anchor="start" font-family="Inter, sans-serif" font-size="7" fill="#8b5e00"/>

    <!-- Subsurface layers -->
    <rect x="50" y="173" width="530" height="130" fill="#f0ead6" opacity="0.4"/>

    <!-- Bouguer slab concept lines -->
    <line x1="50" y1="195" x2="580" y2="195" stroke="#8b5e00" stroke-width="0.5" stroke-dasharray="4,3"/>
    <text x="580" y="192" text-anchor="end" font-family="Inter, sans-serif" font-size="7" fill="#8b5e00">Bouguer slab (ρ avg)</text>

    <!-- Dense body (ore / intrusion) -->
    <ellipse cx="250" cy="240" rx="50" ry="30" fill="#68625b" opacity="0.6" stroke="#111" stroke-width="1"/>
    <text x="250" y="237" text-anchor="middle" font-family="Inter, sans-serif" font-size="9" font-weight="bold" fill="#fff">Dense Body</text>
    <text x="250" y="250" text-anchor="middle" font-family="Inter, sans-serif" font-size="8" fill="#fff">ρ = 2900 kg/m³</text>
    <!-- Upward arrow showing +g -->
    <line x1="250" y1="205" x2="250" y2="182" stroke="#165d34" stroke-width="1.5" marker-end="url(#arr15g)"/>
    <text x="262" y="192" font-family="Inter, sans-serif" font-size="7" fill="#165d34">+Δg</text>

    <!-- Void / cavity -->
    <ellipse cx="460" cy="230" rx="30" ry="22" fill="#fff" stroke="#d92b1f" stroke-width="1.5" stroke-dasharray="3,2"/>
    <text x="460" y="228" text-anchor="middle" font-family="Inter, sans-serif" font-size="9" font-weight="bold" fill="#d92b1f">Void</text>
    <text x="460" y="240" text-anchor="middle" font-family="Inter, sans-serif" font-size="8" fill="#d92b1f">ρ ≈ 0</text>
    <!-- Downward arrow showing -g -->
    <line x1="460" y1="203" x2="460" y2="182" stroke="#d92b1f" stroke-width="1.5" marker-end="url(#arr15r)"/>
    <text x="472" y="192" font-family="Inter, sans-serif" font-size="7" fill="#d92b1f">−Δg</text>

    <!-- Host rock label -->
    <text x="380" y="285" text-anchor="middle" font-family="Inter, sans-serif" font-size="9" fill="#8b5e00">Host rock  ρ = 2200 kg/m³ (loess/alluvium)</text>

    <!-- Depth arrows -->
    <line x1="60" y1="173" x2="60" y2="300" stroke="#68625b" stroke-width="0.8" marker-end="url(#arr15k)"/>
    <text x="55" y="240" text-anchor="end" font-family="Inter, sans-serif" font-size="8" fill="#68625b" transform="rotate(-90,55,240)">Depth</text>

    <defs>
      <marker id="arr15g" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 0 L 10 5 L 0 10 z" fill="#165d34"/>
      </marker>
      <marker id="arr15r" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 0 L 10 5 L 0 10 z" fill="#d92b1f"/>
      </marker>
      <marker id="arr15k" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 0 L 10 5 L 0 10 z" fill="#68625b"/>
      </marker>
    </defs>
  </svg>
  <p class="diagram-caption">Figure — Gravity survey cross-section: gravimeters on the surface measure the Bouguer anomaly profile produced by a dense buried body (positive anomaly) and a void (negative anomaly).</p>
</div>
